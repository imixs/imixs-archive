...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xd:doc scope="stylesheet">
        <xd:desc>
            ...
            <xd:p>Überführt eine zur EN 16931 konforme elektronische Rechnung in der konkreten
                Syntax UNCEFACT.CII.D16B in eine Instanz gemäß des Schemas für den Namensraum
    ...
    <xsl:template match="/rsm:CrossIndustryInvoice">
        <xr:invoice>
            ...
            <xsl:if
                test="count(./rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax/ram:TaxPointDate/udt:DateString[@format = '102']) > 0">
                <xr:Value_added_tax_point_date>
                    <xsl:attribute name="xr:id" select="'BT-7'" />
                    <xsl:attribute name="xr:src"
                        select="'/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax/ram:TaxPointDate/udt:DateString'" />
                    <xsl:call-template name="distinct-bt-7">
                        <xsl:with-param name="date-values"
                            select="distinct-values(./rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax/ram:TaxPointDate/udt:DateString[@format = '102'])" />
                    </xsl:call-template>
                </xr:Value_added_tax_point_date>
            </xsl:if>
            ...
            <xsl:if
                test="count(./rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradePaymentTerms/ram:DueDateDateTime/udt:DateTimeString[@format = '102']) > 0">
                <xr:Payment_due_date>
                    <xsl:attribute name="xr:id" select="'BT-9'" />
                    <xsl:attribute name="xr:src"
                        select="'/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradePaymentTerms/ram:DueDateDateTime'" />
            ...
            <xsl:if
                test="count(./rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradePaymentTerms/ram:Description) > 0">
                <xr:Payment_terms>
                    <xsl:attribute name="xr:id" select="'BT-20'" />
                    <xsl:attribute name="xr:src"
                        select="'/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradePaymentTerms/ram:Description'" />
            ...
            angepasst für BG-16-->
            <xsl:for-each-group
                select="./rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeSettlementPaymentMeans"
    ...
    <xsl:template mode="BG-1"
        ...
        <xsl:variable name="bg-contents" as="item()*"><!--Der
            Pfad /rsm:CrossIndustryInvoice/rsm:ExchangedDocument/ram:IncludedNote der Instanz in
            konkreter Syntax wird auf 2 Objekte der EN 16931 abgebildet. -->
         <xsl:apply-templates mode="BT-21"
                select="./ram:SubjectCode" />
         <xsl:apply-templates mode="BT-22"
                select="./ram:Content" />
        </xsl:variable>
    ...
    <xsl:template mode="BG-2"
        ...
        <xsl:variable name="bg-contents" as="item()*"><!--Der
            Pfad /rsm:CrossIndustryInvoice/rsm:ExchangedDocumentContext der Instanz in konkreter
    ...
    <xsl:template mode="BG-3"
        ...
        <xsl:variable name="bg-contents" as="item()*"><!--Der
            ...
            der Instanz in konkreter Syntax wird auf 2 Objekte der EN 16931 abgebildet. -->
         <xsl:apply-templates mode="BT-25"
                select="./ram:IssuerAssignedID" />
    ...
    <xsl:template mode="BG-4"
        ...
        <xsl:variable name="bg-contents" as="item()*"><!--Der
            ...
            der Instanz in konkreter Syntax wird auf 10 Objekte der EN 16931 abgebildet. -->
         ...
         <xsl:apply-templates mode="BT-29"
                select="./ram:GlobalID[exists(@schemeID)]" />
         <xsl:apply-templates mode="BT-30"
                select="./ram:SpecifiedLegalOrganization/ram:ID" />
         ...
         <xsl:apply-templates
                mode="BT-33" select="./ram:Description" />
         <xsl:apply-templates mode="BT-34"
                select="./ram:URIUniversalCommunication/ram:URIID" />
         <xsl:apply-templates
                mode="BG-5" select="./ram:PostalTradeAddress" />
         <xsl:apply-templates mode="BG-6"
                select="./ram:DefinedTradeContact" />
        </xsl:variable>
      <xsl:if
            test="$bg-contents">
            <xr:SELLER>
    ...
    <xsl:template mode="BG-6"
        ...
        <xsl:variable name="bg-contents" as="item()*"><!--Der
            ...
            der Instanz in konkreter Syntax wird auf 3 Objekte der EN 16931 abgebildet. -->
         <xsl:apply-templates mode="BT-41"
                select="./ram:DepartmentName" />
         <xsl:apply-templates mode="BT-41"
                select="./ram:PersonName" />
         <xsl:apply-templates mode="BT-42"
                select="./ram:TelephoneUniversalCommunication/ram:CompleteNumber" />
         <xsl:apply-templates
                mode="BT-43" select="./ram:EmailURIUniversalCommunication/ram:URIID" />
        </xsl:variable>
      <xsl:if
            test="$bg-contents">
            <xr:SELLER_CONTACT>
    ...
    <xsl:template mode="BG-7"
        ...
        <xsl:variable name="bg-contents" as="item()*"><!--Der
            ...
            der Instanz in konkreter Syntax wird auf 8 Objekte der EN 16931 abgebildet. -->
         ...
         <xsl:apply-templates
                mode="BT-46" select="./ram:GlobalID[exists(@schemeID)]" />
         <xsl:apply-templates
                mode="BT-47" select="./ram:SpecifiedLegalOrganization/ram:ID" />
         <xsl:apply-templates
                mode="BT-48"
                select="./ram:SpecifiedTaxRegistration/ram:ID[@schemeID=('VA', 'VAT')]" />
         <xsl:apply-templates
                mode="BT-49" select="./ram:URIUniversalCommunication/ram:URIID" />
         <xsl:apply-templates
                mode="BG-8" select="./ram:PostalTradeAddress" />
    ...
    <xsl:template mode="BG-8"
        ...
        <xsl:variable name="bg-contents" as="item()*"><!--Der
         ...
         <xsl:apply-templates
                mode="BT-163" select="./ram:LineThree" />
    ...
    <xsl:template mode="BG-9"
        ...
        <xsl:variable name="bg-contents" as="item()*"><!--Der
         ...
         <xsl:apply-templates mode="BT-57"
                select="./ram:TelephoneUniversalCommunication/ram:CompleteNumber" />
         <xsl:apply-templates
                mode="BT-58" select="./ram:EmailURIUniversalCommunication/ram:URIID" />
        </xsl:variable>
      <xsl:if
            test="$bg-contents">
            <xr:BUYER_CONTACT>
    ...
    <xsl:template mode="BG-10"
        ...
        <xsl:variable name="bg-contents" as="item()*"><!--Der
         ...
         <xsl:apply-templates mode="BT-60"
                select="./ram:ID[empty(following-sibling::ram:GlobalID/@schemeID)]" />
         <xsl:apply-templates
                mode="BT-61" select="./ram:SpecifiedLegalOrganization/ram:ID" />
        </xsl:variable>
      <xsl:if
            test="$bg-contents">
            <xr:PAYEE>
    ...
    <xsl:template mode="BG-11"
        ...
        <xsl:variable name="bg-contents" as="item()*"><!--Der
         ...
         <xsl:apply-templates mode="BT-63"
                select="./ram:SpecifiedTaxRegistration/ram:ID" />
         <xsl:apply-templates mode="BG-12"
                select="./ram:PostalTradeAddress" />
        </xsl:variable>
      <xsl:if
            test="$bg-contents">
    ...
    <xsl:template mode="BG-12"
        ...
        <xsl:variable name="bg-contents" as="item()*"><!--Der
         ...
         <xsl:apply-templates
                mode="BT-164" select="./ram:LineThree" />
    ...
    <xsl:template mode="BG-13"
        ...
        <xsl:variable name="bg-contents" as="item()*">
            ...
            <xsl:apply-templates mode="BT-70"
                select="./ram:ApplicableHeaderTradeDelivery/ram:ShipToTradeParty/ram:Name" />
         <xsl:apply-templates
                mode="BT-71"
                select="./ram:ApplicableHeaderTradeDelivery/ram:ShipToTradeParty/ram:ID[empty(following-sibling::ram:GlobalID/@schemeID)]" />
          <xsl:apply-templates
                mode="BT-71"
                select="./ram:ApplicableHeaderTradeDelivery/ram:ShipToTradeParty/ram:GlobalID[exists(@schemeID)]" />
         <xsl:apply-templates
                mode="BT-72"
          ...
          <xsl:apply-templates
                mode="BG-15"
                select="./ram:ApplicableHeaderTradeDelivery/ram:ShipToTradeParty/ram:PostalTradeAddress" />
        </xsl:variable>
      <xsl:if
            test="$bg-contents">
    ...
    <xsl:template mode="BG-15"
        ...
        <xsl:variable name="bg-contents" as="item()*"><!--Der
         ...
         <xsl:apply-templates
                mode="BT-165" select="./ram:LineThree" />
    ...
    <xsl:template mode="BG-16"
        ...
        <xsl:variable name="bg-contents" as="item()*"><!--Der
            ...
            der Instanz in konkreter Syntax wird auf 6 Objekte der EN 16931 abgebildet. -->
          
         <xsl:apply-templates mode="BT-81"
                select="./ram:TypeCode" />
         <xsl:apply-templates mode="BT-82"
                select="./ram:Information" />
         <xsl:apply-templates mode="BT-83"
                select="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:PaymentReference" />
         <xsl:apply-templates
                mode="BG-17" select="./ram:PayeePartyCreditorFinancialAccount" />
         <xsl:apply-templates
                mode="BG-18" select="./ram:ApplicableTradeSettlementFinancialCard" />
         <xsl:apply-templates
                mode="BG-19"
    ...
    <xsl:template mode="BG-17"
        ...
        <xsl:variable name="bg-contents" as="item()*"><!--Der
		 ...
		 <xsl:apply-templates
                mode="BT-86" select="./../ram:PayeeSpecifiedCreditorFinancialInstitution/ram:BICID" />
            <!--
    ...
    <xsl:template mode="BG-19"
        ...
        <xsl:variable name="bg-contents" as="item()*"><!--Der
         ...
         <xsl:apply-templates
                mode="BT-90" select="./ram:CreditorReferenceID" />
    ...
    <xsl:template mode="BG-20"
        ...
        <xsl:variable name="bg-contents" as="item()*"><!--Der
         ...
         <xsl:apply-templates mode="BT-92"
                select="./ram:ActualAmount" />
         <xsl:apply-templates mode="BT-93"
                select="./ram:BasisAmount" />
         <xsl:apply-templates mode="BT-94"
                select="./ram:CalculationPercent" />
         <xsl:apply-templates mode="BT-95"
                select="./ram:CategoryTradeTax/ram:CategoryCode" />
         <xsl:apply-templates mode="BT-96"
                select="./ram:CategoryTradeTax/ram:RateApplicablePercent" />
         <xsl:apply-templates
                mode="BT-97" select="./ram:Reason" />
         <xsl:apply-templates mode="BT-98"
                select="./ram:ReasonCode" />
        </xsl:variable>
      <xsl:if test="$bg-contents">
    ...
    <xsl:template mode="BG-21"
        ...
        <xsl:variable name="bg-contents" as="item()*"><!--Der
         ...
         <xsl:apply-templates mode="BT-102"
                select="./ram:CategoryTradeTax/ram:CategoryCode" />
         <xsl:apply-templates
                mode="BT-103" select="./ram:CategoryTradeTax/ram:RateApplicablePercent" />
         <xsl:apply-templates
                mode="BT-104" select="./ram:Reason" />
    ...
    <xsl:template mode="BG-22"
        ...
        <xsl:variable name="bg-contents" as="item()*"><!--Der
         ...
         <xsl:apply-templates mode="BT-106"
                select="./ram:LineTotalAmount" />
         <xsl:apply-templates mode="BT-107"
                select="./ram:AllowanceTotalAmount" />
         <xsl:apply-templates mode="BT-108"
                select="./ram:ChargeTotalAmount" />
         <xsl:apply-templates mode="BT-109"
                select="./ram:TaxBasisTotalAmount" />
         ...
         <xsl:apply-templates
                mode="BT-112" select="./ram:GrandTotalAmount" />
         <xsl:apply-templates mode="BT-113"
                select="./ram:TotalPrepaidAmount" />
         <xsl:apply-templates mode="BT-114"
                select="./ram:RoundingAmount" />
         <xsl:apply-templates mode="BT-115"
                select="./ram:DuePayableAmount" />
        </xsl:variable>
      <xsl:if test="$bg-contents">
            <xr:DOCUMENT_TOTALS>
    ...
    <xsl:template mode="BG-23"
        ...
        <xsl:variable name="bg-contents" as="item()*"><!--Der
         ...
         <xsl:apply-templates mode="BT-117"
                select="./ram:CalculatedAmount" />
         <xsl:apply-templates mode="BT-118"
                select="./ram:CategoryCode" />
         <xsl:apply-templates mode="BT-119"
                select="./ram:RateApplicablePercent" />
         <xsl:apply-templates mode="BT-120"
                select="./ram:ExemptionReason" />
         <xsl:apply-templates mode="BT-121"
                select="./ram:ExemptionReasonCode" />
        </xsl:variable>
      <xsl:if
            test="$bg-contents">
            <xr:VAT_BREAKDOWN>
    ...
    <xsl:template mode="BG-24"
        ...
        <xsl:variable name="bg-contents" as="item()*"><!--Der
            Pfad
            /rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:AdditionalReferencedDocument
            der Instanz in konkreter Syntax wird auf 4 Objekte der EN 16931 abgebildet. -->
         <xsl:apply-templates mode="BT-122"
                select="./ram:IssuerAssignedID[following-sibling::ram:TypeCode='916']" />
         <xsl:apply-templates
                mode="BT-123" select="./ram:Name" />
         <xsl:apply-templates mode="BT-124"
                select="./ram:URIID" />
         <xsl:apply-templates mode="BT-125"
                select="./ram:AttachmentBinaryObject" />
        </xsl:variable>
      <xsl:if
            test="$bg-contents">
    ...
    <xsl:template mode="BG-25"
        ...
        <xsl:variable name="bg-contents" as="item()*"><!--Der
            ...
            der Instanz in konkreter Syntax wird auf 15 Objekte der EN 16931 abgebildet. -->
         ...
         <xsl:apply-templates
                mode="BG-29" select="./ram:SpecifiedLineTradeAgreement" />
         <xsl:apply-templates
                mode="BG-30"
                select="./ram:SpecifiedLineTradeSettlement/ram:ApplicableTradeTax" />
         <xsl:apply-templates
                mode="BG-31" select="./ram:SpecifiedTradeProduct" />
        </xsl:variable>
      <xsl:if
            test="$bg-contents">
            <xr:INVOICE_LINE>
    ...
    <xsl:template mode="BG-27"
        ...
        <xsl:variable name="bg-contents" as="item()*"><!--Der
            ...
            der Instanz in konkreter Syntax wird auf 5 Objekte der EN 16931 abgebildet. -->
    ...
    <xsl:template mode="BG-29"
        ...
        <xsl:variable name="bg-contents" as="item()*"><!--Der
         ...
         <xsl:apply-templates mode="BT-146"
                select="./ram:NetPriceProductTradePrice/ram:ChargeAmount" />
         <xsl:apply-templates
                mode="BT-147"
         ...
         <xr:Item_price_base_quantity>
                ...
                <xsl:choose>
                    <xsl:when
                        test="./ram:NetPriceProductTradePrice/ram:BasisQuantity != ./ram:GrossPriceProductTradePrice/ram:BasisQuantity">
    ...
    <xsl:template mode="BG-31"
        ...
        <xsl:variable name="bg-contents" as="item()*"><!--Der
         ...
         <xsl:apply-templates
                mode="BT-155" select="./ram:SellerAssignedID" />
         <xsl:apply-templates mode="BT-156"
                select="./ram:BuyerAssignedID" />
         <xsl:apply-templates mode="BT-157"
                select="./ram:GlobalID" />
         <xsl:apply-templates mode="BT-158"
                select="./ram:DesignatedProductClassification/ram:ClassCode" />
         <xsl:apply-templates
                mode="BT-159" select="./ram:OriginTradeCountry/ram:ID" />
         <xsl:apply-templates
                mode="BG-32" select="./ram:ApplicableProductCharacteristic" />
        </xsl:variable>
      <xsl:if
            test="$bg-contents">
            <xr:ITEM_INFORMATION>
