...
public class TikaParserTest {
	...
	public void parserTestDoc() throws Exception {
		...
		FileData fileData = new FileData(fileName, streamToByteArray(inputStream), "doc", null);

		String content = DocumentTikaParser.parse(fileData);
	...
	public void parserTestPdf() throws Exception {
		...
		InputStream inputStream = getClass().getResourceAsStream("/" + fileName);
		FileData fileData = new FileData(fileName, streamToByteArray(inputStream), "pdf", null);
	...
	public void parserTestodt() throws Exception {
		...
		InputStream inputStream = getClass().getResourceAsStream("/" + fileName);
		FileData fileData = new FileData(fileName, streamToByteArray(inputStream), "odt", null);
